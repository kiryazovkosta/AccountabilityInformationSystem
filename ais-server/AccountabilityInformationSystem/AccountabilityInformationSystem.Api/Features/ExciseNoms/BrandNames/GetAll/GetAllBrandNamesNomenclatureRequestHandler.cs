...
using AccountabilityInformationSystem.Api.Features.ExciseNoms.Shared.GetAll;
...
namespace AccountabilityInformationSystem.Api.Features.ExciseNoms.BrandNames.GetAll;
